module.exports = {
	...
	"casetasks": [
		...
		},
		{
			"name": "split",
			"label": "Split Case",
			"tooltip": "Split Case with Case Type selection",
			"resourceName": "cases",
			"type": "split",
			"targetResourceTypes": [
            			{
                		"name": "home",
                		"label": "Home Case Type"
            			},
            			{
                		"name": "auto",
                		"label": "Auto (car) Case Type"
            			}
        		],
			"_links": {
				"root": {
		...
		{
			"name": "splitX",
			"label": "Split Case as a Copy",
			"tooltip": "Split Case without selection of Case Type",
			"resourceName": "cases",
			"type": "split",
			"_links": {
				"root": {
				...
				"self": {
					"href": "/api/config/actions/splitX",
					"type": "application/json"
				}
			}
		},
