module.exports = [
	{
		...
		"dashboards": [
			...
			},
			{
				"id": "page2",
				"title": "Employees Search",
				"tooltip": "Showcase of using search template with pre-defined search filter",
				"lazy": true,
				filter: "gender==Male",
				"components": [
					{
			...
			},
			{
				"id": "page3",
				"title": "Employees Search",
				"tooltip": "Showcase of using multiple search templates",
				"lazy": true,
				"containers": [
					{
						"ui": "tabs",
			...
			{
				"id": "page13",
				"title": "SharePoint View",
				"tooltip": "Showcase of using multiple sharepoint sites",
				"containers": [
					{
						"ui": "tree",
						"components": [
							{
								...
								"_links": {
									...
									"browse": {
										"href": "/api/folders/browse?scope=ce_repository&root=/&offset=0&limit=10"
									}
								}
							},
							{
				...
				"_links": {
					...
					"actions": {
						"href": "/api/config/perspectives/search/dashboards/page13/actions"
					}
				}
			},
			{
			...
			},
			{
				...
				"tooltip": "Showcase of using the enterprise search",
				"lazy": true,
				"containers": [
					{
						"ui": "tabs",
			...
			},
			{
				...
				"tooltip": "Showcase of using external content inside the React container",
				"containers": [
					{
						"ui": "tabs",
						"components": [
